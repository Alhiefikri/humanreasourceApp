                ...
                <div class="card-body">
                    <form action="{{ route('payrolls.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" value="{{ old('salary') }}" name="salary" required>
                            @error('salary')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" value="{{ old('bonuses') }}" name="bonuses" required>
                            @error('bonuses')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" value="{{ old('deductions') }}" name="deductions" required>
                            @error('deductions')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
