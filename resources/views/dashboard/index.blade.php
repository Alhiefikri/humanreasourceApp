                ...
                <div class="card">
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                <h6 class="text-muted font-semibold">Pressences</h6>
                                <h6 class="font-extrabold mb-0">{{ $pressence }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Latest Pressences</h4>
                    </div>
                    <div class="card-body">
                        <canvas id="pressence"></canvas>
                    </div>
                </div>
            </div>
        </div>
                                            ...
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img
                                                            src="https://ui-avatars.com/api/?name={{ $task->employee->full_name }}&background=random">
                                                    </div>
                                                    <p class="font-bold ms-3 mb-0">{{ $task->employee->full_name }}</p>
                                                </div>
                                            </td>
                                            <td class="col-auto">
